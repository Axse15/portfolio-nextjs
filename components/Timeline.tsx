  ...
  return (
    ...
    >
      ...
      <div className="mx-auto max-w-5xl">
        ...
        >
          <p className="text-4xl font-black tracking-[4px] text-cyan-500 dark:text-cyan-300 sm:text-5xl lg:text-6xl">
            Journey
          </p>

          <p className="text-theme-muted mx-auto mt-6 max-w-2xl text-base leading-7 sm:text-lg">
          ...
          <div className="space-y-10">
            {timeline.map((item, index) => (
              ...
              >
                {/* Dot */}
                <div
                  className={`absolute left-2 top-6 h-6 w-6 rounded-full border-4 border-white bg-gradient-to-r ${item.color} dark:border-slate-900`}
                />

                {/* Card */}
                <div className="glass card-theme border-theme rounded-3xl border p-6 transition-all duration-300 hover:-translate-y-1 hover:shadow-xl">
                  <span className="text-sm font-semibold text-cyan-500 dark:text-cyan-300">
                    {item.year}
                  </span>

                  <h3 className="text-theme mt-2 text-xl font-bold sm:text-2xl">
                    {item.title}
                  </h3>
